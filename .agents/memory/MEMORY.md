...
- [HLS ffprobe demuxed false-DOWN](hls-ffprobe-demuxed.md) — ffprobe segment check must pass on has_video OR has_audio; demuxed (JWPlayer) video variants are video-only and were wrongly marked DOWN
